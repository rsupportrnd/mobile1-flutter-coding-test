...
mixin _$Room {
 ...
 String get roomId; String get roomName; String get creator; List<String> get participants; String get createdAt; String? get thumbnailImage; Map<String, dynamic>? get lastMessage;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Room&&(identical(other.roomId, roomId) || other.roomId == roomId)&&(identical(other.roomName, roomName) || other.roomName == roomName)&&(identical(other.creator, creator) || other.creator == creator)&&const DeepCollectionEquality().equals(other.participants, participants)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.thumbnailImage, thumbnailImage) || other.thumbnailImage == thumbnailImage)&&const DeepCollectionEquality().equals(other.lastMessage, lastMessage));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,roomId,roomName,creator,const DeepCollectionEquality().hash(participants),createdAt,thumbnailImage,const DeepCollectionEquality().hash(lastMessage));
...
@useResult
$Res call({
 String roomId, String roomName, String creator, List<String> participants, String createdAt, String? thumbnailImage, Map<String, dynamic>? lastMessage
});
...
/// Create a copy of Room
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? roomId = null,Object? roomName = null,Object? creator = null,Object? participants = null,Object? createdAt = null,Object? thumbnailImage = freezed,Object? lastMessage = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String roomId,  String roomName,  String creator,  List<String> participants,  String createdAt,  String? thumbnailImage,  Map<String, dynamic>? lastMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Room() when $default != null:
return $default(_that.roomId,_that.roomName,_that.creator,_that.participants,_that.createdAt,_that.thumbnailImage,_that.lastMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String roomId,  String roomName,  String creator,  List<String> participants,  String createdAt,  String? thumbnailImage,  Map<String, dynamic>? lastMessage)  $default,) {final _that = this;
switch (_that) {
case _Room():
return $default(_that.roomId,_that.roomName,_that.creator,_that.participants,_that.createdAt,_that.thumbnailImage,_that.lastMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String roomId,  String roomName,  String creator,  List<String> participants,  String createdAt,  String? thumbnailImage,  Map<String, dynamic>? lastMessage)?  $default,) {final _that = this;
switch (_that) {
case _Room() when $default != null:
return $default(_that.roomId,_that.roomName,_that.creator,_that.participants,_that.createdAt,_that.thumbnailImage,_that.lastMessage);case _:
  return null;
...
class _Room implements Room {
  const _Room({this.roomId = '111', this.roomName = '', this.creator = '', final  List<String> participants = const [], this.createdAt = '', this.thumbnailImage, final  Map<String, dynamic>? lastMessage}): _participants = participants,_lastMessage = lastMessage;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Room&&(identical(other.roomId, roomId) || other.roomId == roomId)&&(identical(other.roomName, roomName) || other.roomName == roomName)&&(identical(other.creator, creator) || other.creator == creator)&&const DeepCollectionEquality().equals(other._participants, _participants)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.thumbnailImage, thumbnailImage) || other.thumbnailImage == thumbnailImage)&&const DeepCollectionEquality().equals(other._lastMessage, _lastMessage));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,roomId,roomName,creator,const DeepCollectionEquality().hash(_participants),createdAt,thumbnailImage,const DeepCollectionEquality().hash(_lastMessage));
...
/// Create a copy of Room
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? roomId = null,Object? roomName = null,Object? creator = null,Object? participants = null,Object? createdAt = null,Object? thumbnailImage = freezed,Object? lastMessage = freezed,}) {
  return _then(_Room(
roomId: null == roomId ? _self.roomId : roomId // ignore: cast_nullable_to_non_nullable
as String,roomName: null == roomName ? _self.roomName : roomName // ignore: cast_nullable_to_non_nullable
as String,creator: null == creator ? _self.creator : creator // ignore: cast_nullable_to_non_nullable
