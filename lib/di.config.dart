...
import 'package:mobile1_flutter_coding_test/providers/user/user_list_cubit.dart'
    as _i522;
import 'package:mobile1_flutter_coding_test/repositories/chatting/message_repository_impl.dart'
    as _i663;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.factory<_i501.MessageRepository>(() => _i663.MessageRepositoryImpl());
    ...
    gh.factory<_i345.MessageService>(
        () => _i345.MessageService(gh<_i501.MessageRepository>()));
    gh.factory<_i428.RoomListCubit>(
        () => _i428.RoomListCubit(gh<_i501.RoomService>()));
    gh.factory<_i225.MessageListCubit>(
        () => _i225.MessageListCubit(gh<_i501.MessageService>()));
    return this;
  }
}
