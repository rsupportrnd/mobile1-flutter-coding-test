      ...
      ShellRoute(
          ...
          routes: [
            GoRoute(
              ...
              pageBuilder: (_, state) => NoTransitionPage(key:state.pageKey,child: const UserListPage()),
            ...
            GoRoute(
              ...
              parentNavigatorKey: _shellNavigatorKey,
              pageBuilder: (_, state) => NoTransitionPage(key:state.pageKey,child: const RoomListPage()),
