...
class _$UserListModelImpl implements _UserListModel {
  _$UserListModelImpl({final List<UserModel> users = const []})
      : _users = users;
...
abstract class _UserListModel implements UserListModel {
  factory _UserListModel({final List<UserModel> users}) = _$UserListModelImpl;
...
abstract class _UserModel implements UserModel {
  factory _UserModel(
      ...
      final UserStatus status,
      final RoleType role}) = _$UserModelImpl;
