...
class _UserDatasource implements UserDatasource {
  ...
  Future<UserListResponseModel> getUserList() async {
    ...
    final _options = _setStreamType<UserListResponseModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late UserListResponseModel _value;
    try {
      _value = UserListResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
...
String _$userDatasourceHash() => r'410d0ce14da60c0295fba077f817f5c3da549a20';
