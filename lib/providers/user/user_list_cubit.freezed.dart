...
mixin _$UserListState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<UserModel> userList) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<UserModel> userList)? loaded,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<UserModel> userList) : _userList = userList;
...
abstract class _Loaded implements UserListState {
  const factory _Loaded(final List<UserModel> userList) = _$LoadedImpl;
