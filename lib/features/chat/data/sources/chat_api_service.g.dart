...
class _ChatApiService implements ChatApiService {
  ...
  Future<ChatRoomListResponse> getChatRooms() async {
    ...
    final _options = _setStreamType<ChatRoomListResponse>(
    ...
    late ChatRoomListResponse _value;
    try {
      _value = ChatRoomListResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<ChatMessagesResponse> getMessages() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
