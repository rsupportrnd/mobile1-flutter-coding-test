...
void main() {
  ...
  group('MeetingRoomUseCase', () {
    test('getMeetingRoomList returns data on success', () async {
      const MeetingRoomListResponseEntity dummyEntity =
          MeetingRoomListResponseEntity(meetingRooms: []);
      when(() => mockRepo.getMeetingRoomList()).thenAnswer((_) async => dummyEntity);
